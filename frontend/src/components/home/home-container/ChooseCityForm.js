...
const ChooseCityForm = ({ getNearbyPlaces }) => {
  return (
    <div className='my-5 mx-auto'>
      <form onSubmit={(e) => getNearbyPlaces(e)}>
        ...
        <div className='flex items-center justify-center mt-3'>
          <input className='shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline w-full p-1 text-black' type='text' name='city' />

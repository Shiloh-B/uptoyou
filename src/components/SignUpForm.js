...
const SignUpForm = ({ handleSignUp, handleFormChange }) => {
  ...
  return (
    <div className='flex justify-center w-2/5 my-0 mx-auto'>
      <form className='flex flex-col bg-white shadow-lg rounded px-3 py-3 my-5 justify-center bg-slate-100 w-full p-10' onSubmit={handleSignUp}>
        ...
        <div className='flex flex-col my-0 mx-auto w-3/5 mb-2'>
          ...
          <input className='shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline w-full p-1' type='text' name='username' onChange={handleFormChange} />
        </div>
        ...
        <div className='flex flex-col my-0 mx-auto w-3/5 mb-3'>
          ...
          <input className='shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline w-full p-1'type='password' name='confirmPassword' onChange={handleFormChange} />
        </div>

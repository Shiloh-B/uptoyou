...
const SignUpForm = ({ handleSignUp, handleFormChange, errors, setErrors }) => {
  ...
  return (
    <div className='flex justify-center w-full h-screen my-0 mx-auto bg-blue-400 items-center'>
      <form className='flex flex-col  shadow-lg rounded px-3 py-3 my-5 justify-center bg-slate-100 w-2/5 p-10' onSubmit={handleSignUp}>
        <h1 className='text-center text-6xl font-montserrat font-bold'>Up To You</h1>
        <div className='text-center my-3'>
          <h1 className='text-xl my-1'>Create Your Account</h1>
        </div>
        ...
        <div className='flex flex-col my-0 mx-auto w-3/5 mb-2'>
          ...
          <input className='shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline w-full p-1' type='text' name='username' required onChange={handleFormChange} />
        </div>
        <div className='flex flex-col my-0 mx-auto w-3/5 mb-3'>
          <label htmlFor='password'>Password</label>
          <input className='shadow appearance-none border rounded leading-tight focus:outline-none focus:shadow-outline w-full p-1'type='password' name='password' required onChange={handleFormChange} />
        ...
        <div className='flex flex-row justify-center items-center my-1 mx-auto w-4/5'>
          <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold w-1/5 py-2 px-2 mx-3 rounded' type='submit'>Sign Up</button>
        </div>
        <div className='mt-4'>
